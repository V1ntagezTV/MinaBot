...
namespace MinaBot.HelpActions
{
    ...
    {
        private const string InviteLink =
            @"https://discord.com/api/oauth2/authorize?client_id=566896476756639744&permissions=0&scope=bot";
        ...
        public MessageResult GetView(CommandModel cmdModel)
        {
            ...
            var embed = new EmbedBuilder()
            {
                ...
                Description = $"[`Invite bot`]({InviteLink}) [`Dev. Server`]({ServerLink})\n"+
                              "Use ` m!help <command> ` to get more information about command.",
